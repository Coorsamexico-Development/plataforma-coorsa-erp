...
class NominasController extends Controller
{
    ...
    public function getNominasByUser(Request $request)
    {
        return response()->json(DB::table('nominas_empleados')->where('empleado_id', $request->id)->orderByDesc('fecha_doc')->orderByDesc('periodo')->paginate(5));
    }
}
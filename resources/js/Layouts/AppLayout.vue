...
<template>
    <div>
        ...
        <div class="min-h-screen bg-gray-100">
                        ...
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <Dropdown align="right" width="48" >
                                    ...
                                    <template #content>
                                        <DropdownLink :href="route('empleado.indexmanual', {activo: 'activo'})">
                                            Empleados Activos
                                        </DropdownLink>
            ...
            <!-- Page Heading -->
            <header v-if="$slots.header" class="bg-white shadow" style="margin-top:1rem; margin-right:2rem; margin-left:2rem; border-radius: 1rem;">

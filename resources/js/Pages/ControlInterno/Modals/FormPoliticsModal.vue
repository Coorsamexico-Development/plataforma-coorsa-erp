    ...
    <DialogModal :show="show" maxWidth="2xl" @close="close()">
                ...
                <div class="grid grid-cols-2 gap-2 md:grid-cols-2">
                    <div class="mt-2">
                        <InputLabel for="namepolitica">
                            Nombre del documento:<span class="text-red-400"
                                >*</span
                            >
                        </InputLabel>
                        ...
                        <TextInput
                            id="namepolitica"
                            type="text"
                            v-model="form.namepolitica"
                            placeholder="Nombre Politica"
                            class="block w-full mt-1"
                            maxlength="60"
                            required
                        />
                        <InputError
                            :message="form.errors.namepolitica"
                            class="mt-2"
                        />
                    </div>
                    <div class="mt-2">
                        <InputLabel for="descripcion">
                            Descripci&oacute;n:<span class="text-red-400"
                                >*</span
                            >
                        </InputLabel>
                        <TextInput
                    ...
                    <div class="mt-2">
                        ...
                        <SelectComponent v-model="form.type_politic" required>
                            <option
                                v-for="tipoPolit in tipoPoliticas"
                                :key="tipoPolit.id"
                                :value="tipoPolit.id"
                            >
                                {{ tipoPolit.name }}
                        ...
                        <InputError
                            :message="form.errors.type_politic"
                            class="mt-2"
                        />
                    </div>
                    <div class="mt-2">
                    ...
                    <div class="mt-2">
                        <InputLabel for="imagePolitic"> Imagen: </InputLabel>
                        <input
                            type="file"
                            class="hidden"
                            ref="fileImage"
                            name="imagePolitic"
                            @change="setFileNameImg()"
                            accept=".jpg,.jpeg,.png"
                        />
                        <span class="text-xs">{{ fileNameImg }}</span>
                        <SecondaryButton
                            type="button"
                            @click="selectFileImage()"
                        >
                            <svg
                        ...
                        <InputError
                            :message="form.errors.imagePolitic"
                            class="mt-2"
                        />
                    </div>
                    <div class="mt-2">
        ...
        <template #footer>
            <div class="mx-2 my-2">
                ...
                <DangerButton
                    v-if="
                        $page.props.can['politics.delete'] &&
                        typeForm !== 'create'
                    "
                    class="ml-4"
                    @click="deletePolitica()"
                    :disabled="processingDelete"
                >
                    <SpinProgress
                        v-if="processingDelete"
                        :inprogress="processingDelete"
                    />
                    Eliminar
                </DangerButton>
                <PrimaryButton

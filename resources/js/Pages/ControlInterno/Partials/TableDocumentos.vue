        ...
        <tbody>
            <tr v-for="documento in documentos" :key="documento.id">
                <td>
                    ...
                    <button @click="borrarDoc(documento.id)"  class="bg-[#ec677e] m-2 rounded-2xl pl-2 pr-2">
                ...
                <td class="text-center">
                    {{ documento.user_name + ' '+ documento.user_apellido_paterno + ' ' + documento.user_apellido_materno}}
                </td>
                <td class="text-center">
                    <div v-if="documento">
                        <button v-if="documento.documento.endsWith('.pdf') || documento.documento.endsWith('.png') || documento.documento.endsWith('.jpg') || documento.documento.endsWith('.svg')"  class="bg-[#0097F2] pl-2 pr-2 rounded-3xl"  data-fancybox :href="documento.documento" >
                        ...
                        <button v-else class="bg-[#0097F2] pl-2 pr-2 rounded-3xl"  download :href="documento.documento" >
                          <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="38" height="35" viewBox="0 0 38 35">
                             <defs>
                               <clipPath id="clip-Icono-imagen">
                                 <rect width="38" height="35"/>

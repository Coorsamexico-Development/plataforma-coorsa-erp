                        ...
                        <template #section-header>
                            ...
                            >
                                <div class="flex justify-between gap-2">
                                    ...
                                    <div>
                                        Total Global:<span
                                            class="px-1 text-white bg-blue-600 rounded-md"
                                            >{{ totalGlobal }}
                                        </span>
                                        <span> Ocupado/Autorizado</span>
                                    </div>
                                    <div
                                        v-if="
                                            $page.props.can[
                        ...
                        <template #table-header>
                            <tr class="text-center">
                                ...
                                >
                                    PUESTOS
                                    <template
                                        v-if="params.field === 'puestos.name'"
                                    >
                                        <svg
                                ...
                                <template
                                    v-if="$page.props.can['ubicaciones.update']"
                                >
                                    <PlantillaHeaderEdit

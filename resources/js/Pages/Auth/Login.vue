...
<template>
    ...
    <div class="login">
        ...
        >
            <div class="pl-4">
                <span
                    class="w-1 h-20 bg-[#EC2944] mt-1"
                    style="position: absolute; width: 0.1rem"
                ></span>
                <h1 class="ml-2 text-xl" style="font-family: 'Montserrat'">
                    Bienvenido a<br />
            ...
            <div class="pr-4">
                <img src="../../../img/Icono-coorsa.svg" alt="" />
            </div>
        </div>

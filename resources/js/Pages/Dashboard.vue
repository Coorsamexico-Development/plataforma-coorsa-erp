        ...
        <section class="inicio">
            <div class="inicio_info">
                <div class="sm:ml-16 ml-8 mt-20 sm:mt-0 inicio_info_text">
                    ...
                    <h3
                        ...
                        style="font-family: 'Montserrat'"
                    >
                        <span>Cónoce </span> más sobre coorsa
                    </h3>
                    <span
                        style="position: absolute"
            ...
            <div class="inicio_quienes_somos">
                <div class="inicio_quienes_somos_title">
                    <h3
                        class="text-[rgb(236,41,68)] font-bold text-4xl sm:text-5xl"
                        style="font-family: 'Montserrat'; font-weight: 500"
                    >
                        QUIENES
                    </h3>
                    <h3
                        class="text-[#1D2B4E] font-bold text-8xl sm:text-9xl"
                ...
                <div class="inicio_quienes_somos_text">
                    ...
                    >
                        ...
                        empresa dedicada a innovar y<br />
                        mejorar procesos de la cadena de suministros con<br />
                        más de 10 servicios dentro del rango del ramo
                        logístico<br />

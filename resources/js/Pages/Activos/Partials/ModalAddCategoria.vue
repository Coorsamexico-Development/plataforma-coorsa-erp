        ...
        <template #content>
                ...
                <div class="grid grid-cols-3 grid-rows-1">
                    <div class="">
                        ...
                        <TextInput
                            ...
                            class="mr-2 border border-slate-400"
                        ></TextInput>
                ...
                >
                    ...
                    <div class="mr-2">
                        ...
                        <SelectComponent v-model="campo.tipo_input_id">
                            ...
                            <option
                                v-for="tipoInput in tipo_inputs"
                                :key="tipoInput.id"
                                :value="tipoInput.id"
                            >
                                {{ tipoInput.nombre }}
            ...
            <div class="flex flex-row-reverse">
                <button
                    @click="saveCategory"
                    style=""
                    class="p-2 bg-blue-500 rounded-lg hover:opacity-50"
                >
                    <svg
                        style=""
                    ...
                    >
                        ...
                        <g
                            id="Icono-guardar"
                            clip-path="url(#clip-Icono-guardar)"
                        >
                            <rect
                                width="30"
                                height="30"
                            ...
                            <g
                                id="Grupo_515"
                                data-name="Grupo 515"
                                transform="translate(-7685 -2974)"
                            >
                                <g
                                    id="Grupo_512"
                                    data-name="Grupo 512"
                                    transform="translate(7689.417 2978.855)"
                                >
                                    <g id="Grupo_491" data-name="Grupo 491">
                                        <path
                                            id="Trazado_316"
                                            data-name="Trazado 316"
                                            d="M18.974,0H2.6A2.6,2.6,0,0,0,0,2.6v16.97a2.6,2.6,0,0,0,2.6,2.6h16.97a2.6,2.6,0,0,0,2.6-2.6V3.191ZM5.195,1.732h9.957V6.84H5.195Zm11.775,18.7H5.195v-6.84H16.97Zm3.463-.866a.867.867,0,0,1-.866.866H18.7V11.862H3.463v8.572H2.6a.867.867,0,0,1-.866-.866V2.6A.867.867,0,0,1,2.6,1.732h.866v6.84h13.42V1.732h1.373l2.177,2.177Z"
                                            fill="#fff"
                                        />
                                    </g>
                                </g>

...
const emitAxios = () =>
{
 ...
 let infoUser = ref([]);
 axios.get('/getInfoEmpleado/'+props.usuario.empleado_id).then((response)=> 
 {
            ...
            <template #content>
                 <div class="grid grid-cols-3">
                   <div class="flex flex-col justify-center ">
                     ...
                     <div class="flex mt-2">
                       <div class="mt-2" v-if="images.length > 0">
                        <div v-for="(imagen , index) in images" :key="imagen.id">
                           <button v-if="index == 0" class="bg-[#0097F2] pl-2 pr-2 rounded-3xl block" :href="imagen.foto" :data-fancybox="'gallery-b'">
                           ...
                           <g id="Icono-imagen" clip-path="url(#clip-Icono-imagen)">
                            ...
                            <button  v-if="index > 0"  class="bg-[#0097F2] pl-2 pr-2 rounded-3xl hidden" :href="imagen.foto" :data-fancybox="'gallery-b'">
                             <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="38" height="35" viewBox="0 0 38 35">
                           <defs>
                             <clipPath id="clip-Icono-imagen">
                               <rect width="38" height="35"/>

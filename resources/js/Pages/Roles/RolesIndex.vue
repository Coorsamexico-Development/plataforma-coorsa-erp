...
<template>
    <AppLayout title="Users" :nominas="nominas">
        <template #header>
        ...
        <div class="px-2 py-6">
            <div class="grid grid-cols-1 md:grid-cols-2">
                <div
                    class="px-1 py-2 overflow-hidden shadow-xl white-transparent sm:rounded-lg"
                >
                    <h1 class="mx-10 mt-4 text-lg font-bold border-b-2">
                        Roles de Usuario
                    </h1>
                ...
                <div
                    class="px-1 ml-5 overflow-hidden shadow-xl white-transparent sm:rounded-lg"
                >
                    <h1 class="mx-10 mt-4 text-lg font-bold border-b-2">
                        Permisos
                    </h1>
                    ...
                    <PermissionsTable
                        :role="roleSelect"
                        :permissions="laravelPermissions"

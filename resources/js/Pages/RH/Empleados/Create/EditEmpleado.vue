...
const form = useForm
    ({
        ...
        'apellido_paterno': props.empleado.apellido_paterno === null ? '' : props.empleado.apellido_paterno,
        'apellido_materno': props.empleado.apellido_materno === null ? '' : props.empleado.apellido_materno,
        'fecha_nacimiento': props.empleado.fecha_nacimiento === null ? '' : props.empleado.fecha_nacimiento,
        'fecha_ingreso': props.empleado.fecha_ingreso,
        'fecha_ingreso_real': props.empleado.fecha_ingreso_real,
        'fecha_baja': '',
        'departamento_id': props.departamento_puesto !== null ? props.departamento_puesto.departamento_id : '',
        'puesto_id': props.departamento_puesto !== null ? props.departamento_puesto.puesto_id : '',
    ...
    <app-layout title="Dashboard">
        ...
        <div class="space">
            <MenuSection @changeMenu="cambiar($event)" :menu-seleted="menuSeleted">
                <ButtonSeccion v-if="$page.props.can['users.update-finiquito']" @click="cambiar(8)"
        ...
        <div class="px-24 py-3">
            <div class="shadow-xl sm:rounded-lg">
                <div class="pl-8 pr-8 ">
                    ...
                    <!--Fin Expediente -->
                    <!-- Finiquitos -->
                    <SectionFiniquitos v-if="menuSeleted == 8" :form="form" :motivos-bajas="props.cat_bajas" />
                    <!-- Fin Finiquitos -->
                    <div class="flex justify-end gap-2">
                        <Link
                            :href="route('empleado.indexmanual', { activo: props.empleado.activo == 1 ? 'activo' : 'inactivo' })"
                            replace>
                        <ButtonInfo>
                            Regresar
                        </ButtonInfo>

                    ...
                    <div class="pb-8 pl-8 pr-8">
                                            ...
                                            <div class="grid grid-cols-3 gap-4">
                                                <div class="mt-4">
                                                    ...
                                                    <TextInput id="numero_empleado" type="text"
                                                        ...
                                                        placeholder="No. Empleado" :disabled="editEmpleadoDisable" />
                                                ...
                                                <div class="mt-4">
                                                    ...
                                                    <TextInput id="curp" type="text" v-model="form.curp"
                                                        class="block w-full mt-1" :placeholder="generateCurp"
                                                        maxlength="18" :disabled="editEmpleadoDisable" />
                                                ...
                                                <div class="mt-4">
                                                    ...
                                                    <TextInput id="correo_electronico" type="text"
                                                        ...
                                                        :disabled="editEmpleadoDisable" />
                                                    <InputError :message="form.errors.correo_electronico"
                                                        class="mt-2" />
                                                </div>
                                                <div class="mt-4">
                                                ...
                                                <div class="mt-4">
                                                    ...
                                                    <TextInput id="contacto_emergencia" type="text"
                                                        ...
                                                        :disabled="editEmpleadoDisable" />
                                                    <InputError :message="form.errors.contacto_emergencia"
                                                        class="mt-2" />
                                                </div>
                                                <div class="mt-4">
                                            ...
                                            <div class="grid grid-cols-3 gap-4">
                                                ...
                                                <div class="mt-4">
                                                    ...
                                                    <ListInputVue list="listaEstados" :disabled="editEmpleadoDisable"
                                                        ...
                                                        @click="getEstados()" />
                                                    <InputError :message="form.errors.direccion_estado_id"
                                                        class="mt-2" />
                                                </div>
                                                <div class="mt-4">
                                                    ...
                                                    <ListInputVue v-if="form.direccion_estado_id != 0"
                                                        ...
                                                        :options="catalogos.municipiosDireccion"
                                                ...
                                                <div class="mt-4">
                                                    ...
                                                    <ListInputVue list="listaLocalidades"
                                                        ...
                                                        :options="catalogos.localidadesDireccion"
                        ...
                        <div v-if="buttonSelected == 3">
                            <div class="border-b tab">
                                <div class="relative border-l-2 border-transparent">
                                    <input class="absolute z-10 w-full h-10 opacity-0 cursor-pointer top-6"
                                        type="checkbox" id="datosPersonale" checked>
                                    <header
                                        class="flex items-center justify-between p-5 pl-8 pr-8 cursor-pointer select-none tab-label"
                                        for="datosPersonales">
                                        <span class="text-xl font-thin text-grey-darkest">
                                        ...
                                        <div class="pb-5 pl-8 pr-8">
                                            <div class="grid grid-cols-3 gap-4">
                                                ...
                                                <div class="mt-4">
                                                    ...
                                                    <TextInput id="clave_bancaria" type="text"
                                                        v-model="form.clave_bancaria" class="block w-full mt-1"
                                        ...
                                        <div class="pb-5 pl-8 pr-8">
                                            <div class="grid grid-cols-3 gap-4">
                                                ...
                                                <div class="mt-4">
                                                    ...
                                                    <TextInput id="fecha_ingreso" type="date"
                                                        v-model="form.fecha_ingreso" class="block w-full mt-1"
                                                        placeholder="Fecha de Ingreso" max="2030-12-12"
                                                        :disabled="editEmpleadoDisable" />
                                                ...
                                                <div class="mt-4">
                                                    ...
                                                    <TextInput id="fecha_ingreso_real" type="date"
                                                        ...
                                                        :disabled="editEmpleadoDisable" />
                                                    <InputError :message="form.errors.fecha_ingreso_real"
                                                        class="mt-2" />
                                                </div>
                                                <div class="mt-4">
                                                    ...
                                                    <InputError :message="form.errors.cat_tipos_nomina_id"
                                                        class="mt-2" />
                                                </div>
                                                <div class="mt-4">
                                        ...
                                        <div class="pb-5 pl-8 pr-8">
                                            <div class="grid grid-cols-6 gap-4">
                                                ...
                                                <div class="col-span-2">
                                                    ...
                                                    <TextInput id="salario_bruto" type="number"
                                                        v-model="form.salario_bruto" class="block w-full mt-1"
                                                        placeholder="$ 00.0" :disabled="editEmpleadoDisable"
                                            ...
                                            <div class="grid grid-cols-3 gap-4">
                                                ...
                                                <div class="mt-4">
                                                    ...
                                                    <TextInput id="enfermedades_cronicas" type="text"
                                                        ...
                                                        :disabled="editEmpleadoDisable" />
                                                    <InputError :message="form.errors.enfermedades_cronicas"
                                                        class="mt-2" />
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="grid grid-cols-3 gap-4">
                                                <template v-if="!editEmpleadoDisable">
                                                    <div class="mt-4">
                                                        ...
                                                        <DropZone id="fotografia" v-model="form.fotografia"
                                ...
                                <div class="relative border-l-2 border-transparent">
                                    ...
                                    <div class="tab-content">
                                        <div class="pb-5 pl-8 pr-8">
                                            <div class="grid grid-cols-3 gap-4">
                                                <div class="mt-4">
                                                    <component-label for="cat_bajas_empleado_id"
                                                        value="Motivo de Baja:*" />
                                                    <component-select v-model="form.cat_bajas_empleado_id"
                                                        class="w-full" :disabled="!$page.props.can['empleados.delete']">
                                                ...
                                                <div class="mt-4">
                                                    ...
                                                    <component-input id="fecha_baja" type="date" max="2030-12-31"
                                                ...
                                                <div class="mt-4">
                                                    <component-label for="fecha_finiquito"
                                                        value="Fecha de Finiquito:*" />
                                                ...
                                                <div class="mt-4">
                                                    <component-label for="monto_finiquito"
                                                        value="Monto de Finiquito:*" />

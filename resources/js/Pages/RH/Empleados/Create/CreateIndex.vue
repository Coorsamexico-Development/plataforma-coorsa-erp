...
const getCatalogos = () => 
{
    axios.get(route('catalogos.formularioempelado')).then( (response) => 
    {
                    ...
                    <main class="w-full p-4 mx-auto">
                        <section class="shadow row">
                            <div class="tabs">
                                            ...
                                            <div class="pb-5 pl-8 pr-8">
                                                <div class="grid grid-cols-3 gap-4">
                                                    ...
                                                    <div class="mt-4">
                                                        ...
                                                        <TextInput list="listaEstados"
                                                         type="text" :disabled="editEmpleadoDisable"
                                                        v-model="form.direccion_estado_id" :opciones="catalogos.estadosDireccion"
                                                    ...
                                                    <div class="mt-4">
                                                         ...
                                                         <TextInput list="listaMunicipios" 
                                                         type="text" :disabled="editEmpleadoDisable"
                                                         v-model="form.direccion_municipio_id"  :opciones="municipiosDireccion"
                                ...
                                <div class="border-b tab">
                                    <div class="relative border-l-2 border-transparent">
                                        <input class="absolute z-10 w-full h-10 opacity-0 cursor-pointer top-6" type="checkbox" id="datosPersonale">
                                        <header class="flex items-center justify-between p-5 pl-8 pr-8 cursor-pointer select-none tab-label" for="datosPersonales">
                                            <span class="text-xl font-thin text-grey-darkest">
                                            Datos Bancarios
                                            </span>
                                                ...
                                                <div class="grid grid-cols-3 gap-4">
                                                    <template v-if="!editEmpleadoDisable">
                                                        <div class="mt-4">
                                                            ...
                                                            <DropZone id="fotografia" v-model="form.fotografia" accept="image/x-png,image/jpeg"/>

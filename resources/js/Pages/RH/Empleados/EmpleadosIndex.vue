        ...
        <template #header>
            ...
            <a :href="route('export.empleados', activo)">
                <ButtonInfo style="float:right; margin-top: -1.5rem; " >
                    <svg id="Capa_1" data-name="Capa 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 15.5 18" style="width:1rem; fill: white; margin-right: 0.5rem;">
           ...
           <div v-if="activo === 'activo'">
                ...
                <ButtonAdd style="float:right; margin-top: -1.5rem; margin-right: 2rem; ">
                    <span style="font-size:1.4rem; margin-right:0.5rem">+</span> AGREGAR
                </ButtonAdd>
                </Link>
            </div>

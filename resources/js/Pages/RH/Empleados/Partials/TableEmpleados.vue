...
watch(
    ...
    throttle((newParams) => {
        ...
        const clearParams = pickBy({
            fields: newParams.fields,
            searchs: Object.keys(searchs).length === 0 ? null : searchs,
        });
            ...
            <tr class="text-center">
                ...
                >
                    <span class="block my-1" @click="sort('numero_empleado')">
                        ...
                        <template
                            v-if="
                                params.fields &&
                                params.fields['numero_empleado']
                            "
                        >
                            <svg
                                v-if="
                                    params.fields['numero_empleado'] === 'asc'
                                "
                    ...
                    <ShortInput
                        type="search"
                        v-model="params.searchs.numero_empleado"
                    />
                </th>
                <th
                    scope="col"
                ...
                >
                    <span class="block my-1" @click="sort('cecos.nombre')">
                        ...
                        <template
                            v-if="
                                params.fields && params.fields['cecos.nombre']
                            "
                        >
                            <svg
                                v-if="params.fields['cecos.nombre'] === 'asc'"
                                xmlns="http://www.w3.org/2000/svg"
                                class="inline w-4 h-4"
                                viewBox="0 0 20 20"
                                fill="currentColor"
                    ...
                    <ShortInput
                        type="search"
                        v-model="params.searchs['cecos.nombre']"
                    />
                </th>
                <th
                    scope="col"
                ...
                >
                    <span class="block my-1" @click="sort('puestos.name')">
                        ...
                        <template
                            v-if="
                                params.fields && params.fields['puestos.name']
                            "
                        >
                            <svg
                                v-if="params.fields['puestos.name'] === 'asc'"
                                xmlns="http://www.w3.org/2000/svg"
                                class="inline w-4 h-4"
                                viewBox="0 0 20 20"
                                fill="currentColor"
                    ...
                    <ShortInput
                        type="search"
                        v-model="params.searchs['puestos.name']"
                    />
                </th>
                <th
                    scope="col"
                ...
                >
                    <span class="block my-1" @click="sort('users.name')">
                        NOMBRE
                        <template
                            v-if="params.fields && params.fields['users.name']"
                        >
                            <svg
                                v-if="params.fields['users.name'] === 'asc'"
                                xmlns="http://www.w3.org/2000/svg"
                                class="inline w-4 h-4"
                                viewBox="0 0 20 20"
                                fill="currentColor"
                    ...
                    <ShortInput
                        type="search"
                        v-model="params.searchs['users.name']"
                    />
                </th>
                <th
                    scope="col"
                ...
                >
                    <span class="block my-1" @click="sort('apellido_paterno')">
                        ...
                        <template
                            v-if="
                                params.fields &&
                                params.fields['apellido_paterno']
                            "
                        >
                            <svg
                                v-if="
                                    params.fields['apellido_paterno'] === 'asc'
                                "
                                xmlns="http://www.w3.org/2000/svg"
                                class="inline w-4 h-4"
                                viewBox="0 0 20 20"
                    ...
                    <ShortInput
                        type="search"
                        v-model="params.searchs.apellido_paterno"
                    />
                </th>
                <th
                    scope="col"
                ...
                >
                    <span class="block my-1" @click="sort('apellido_materno')">
                        ...
                        <template
                            v-if="
                                params.fields &&
                                params.fields['apellido_materno']
                            "
                        >
                            <svg
                                v-if="
                                    params.fields['apellido_materno'] === 'asc'
                                "
                                xmlns="http://www.w3.org/2000/svg"
                                class="inline w-4 h-4"
                                viewBox="0 0 20 20"
                    ...
                    <ShortInput
                        type="search"
                        v-model="params.searchs.apellido_materno"
                    />
                </th>
                <th
                    scope="col"
                ...
                >
                    <span class="block my-1" @click="sort('users.telefono')">
                        ...
                        <template
                            v-if="
                                params.fields && params.fields['users.telefono']
                            "
                        >
                            <svg
                                v-if="params.fields['users.telefono'] === 'asc'"
                                xmlns="http://www.w3.org/2000/svg"
                                class="inline w-4 h-4"
                                viewBox="0 0 20 20"
                                fill="currentColor"
                    ...
                    <ShortInput
                        type="search"
                        v-model="params.searchs['users.telefono']"
                    />
                </th>
                <th
                    scope="col"
                ...
                <td class="px-2 whitespace-nowrap">
                    <div class="flex items-center justify-center">
                        <ButtonPhoto
                            ...
                            :data-fancybox="'single' + empleado.id"
                        ...
                        <DropdownButton>
                            <template #button>
                                <span
                                    class="absolute px-1 text-white bg-red-500 rounded -left-1 -top-1"
                                    >{{ empleado.expedientes.length }}</span
                                >
                                <svg
                                    class="w-4 h-4"
                                    fill="currentColor"
                            ...
                            <template #content>
                                <ul>
                                    <li
                                        v-for="(
                                            expendiente, index
                                        ) in empleado.expedientes"
                                        :key="index"
                                        class="hover:bg-gray-600"
                                    >
                                        <div
                                            :data-fancybox="
                                                empleado.id + '-expediente'
                                            "
                                            :data-src="expendiente.ruta"
                                            :data-caption="

                ...
                <div class="pb-5 pl-8 pr-8">
                    <div class="grid grid-cols-4 gap-4">
                        <div class="mt-4">
                            ...
                            />
                            <div
                                v-if="form.fotografia_url"
                                class="text-green-500 cursor-pointer hover:opacity-80"
                            >
                                <a
                                    data-fancybox="fotografia"
                                    :data-src="form.fotografia_url"
                                >
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        fill="currentColor"
                            ...
                            <InputError
                                :message="form.errors.fotografia"
                                class="mt-2"
                            />
                        </div>
                        <div class="mt-4">
                            <InputLabel
                                for="foto_empresarial"
                                value="Foto Empresarial:"
                            />
                            <DropZone
                                v-if="canEdit"
                                id="foto_empresarial"
                                v-model="form.foto_empresarial"
                                ref="fotografia_empresarial"
                                accept="image/x-png,image/jpeg"
                            />
                            <div
                                v-if="form.foto_empresarial_url"
                                class="text-green-500 cursor-pointer hover:opacity-80"
                            >
                                <a
                                    data-fancybox="fotografia"
                                    :data-src="form.foto_empresarial_url"
                                >
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        fill="currentColor"
                            ...
                            <InputError
                                :message="form.errors.foto_empresarial"
                                class="mt-2"
                            />
                        </div>

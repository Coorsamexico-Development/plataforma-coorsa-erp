    ...
    <div>
        <data-table>
            ...
            <template #table-header>
                <th scope="col" class="w-1/6 text-xs font-semibold tracking-wider text-gray-500 uppercase ">
                    <span class="inline-flex justify-between w-full px-6 py-3" @click="sort('')">Acciones
                ...
                <th scope="col" class="w-4/6 text-xs font-semibold tracking-wider text-gray-500 uppercase">
                ...
                <th scope="col" class="w-1/6 text-xs font-semibold tracking-wider text-gray-500 uppercase">
                    <span class="inline-flex justify-between w-full px-6 py-3" @click="sort('activo')">Activo
            ...
            <template #table-body>
                <tr v-for='(puesto, index) in puestos.data' :key="index">
                    ...
                    <td class="px-1 py-2 text-sm text-left text-gray-500 uppercase break-all">
                        {{ puesto.name }}
                    </td>
                    <td class="px-1 py-2 text-sm text-center text-gray-500 uppercase break-all">
                        <svg v-if="puesto.activo" class="w-6 h-6 m-auto text-green-500"
        ...
        <puesto-modal :show="showingPuesto" :puesto="puestoSelect" :typeForm="typeForm" @close="closeModalPuesto"
